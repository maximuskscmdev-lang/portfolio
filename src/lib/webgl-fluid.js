function e(e, t) {
	...
	n.addEventListener("mousedown", (e) => {
		...
		setTimeout(() => {
			n.addEventListener("mousemove", (e) => {
				let now = Date.now();
				if (now - _lastMove > 300) {
					i[0].color = Z();
				}
				_lastMove = now;
				let t = $(e.offsetX), n = $(e.offsetY);
				if (isNaN(t)) t = $(e.clientX);
				if (isNaN(n)) n = $(e.clientY);
				Ge(i[0], t, n);
			});
		}, 500);
	...
	function getPastelColors() {
		return [
			{ r: 0.25, g: 0.15, b: 0.4 },  // Muted Purple
			{ r: 0.15, g: 0.3, b: 0.45 },  // Slate Blue
			{ r: 0.4, g: 0.15, b: 0.25 },  // Dusty Rose
			{ r: 0.4, g: 0.3, b: 0.15 },   // Muted Gold
			{ r: 0.15, g: 0.35, b: 0.25 }, // Sage Green
			{ r: 0.25, g: 0.25, b: 0.35 }, // Steel Gray
			{ r: 0.3, g: 0.15, b: 0.35 }   // Deep Plum
		];
	}
	function Z() {
		let colors = getPastelColors();
